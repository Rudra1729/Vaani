...
# """
    ...
    prompt = f""" You must return valid Markdown only.
Use section headers on their own line, then the body on the next line(s).
Required sections in this order:
“### Operational Context”, “### Other Use-cases”, “### Caveats”.
Do not place any prose on the same line as a header. Explain the specific meaning and context of the term '{search_term}' 
based EXCLUSIVELY on this technical document passage and give a properly structured answer with proper line spacing and framework. Include:
...
Give me the answer in a paragraph with two headings 'Operational Context' and 'Other Use-cases'. Each paragraph should not exceed 50 words. It should not have special characters
like ###.
